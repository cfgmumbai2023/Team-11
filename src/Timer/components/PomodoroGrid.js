    ...
    return (
        <div style={{ height: '50%', width: '100%' }}>
            <AgGridReact
                ...
                animateRows={true}
                overlayNoRowsTemplate={'<span className="ag-overlay-no-rows-center">No Tasks To Show. Add Tasks using the Toolbar below.</span>'}
                overlayLoadingTemplate={`<span className="ag-overlay-loading-center">Please stop the timer before clicking an action.</span>`}
